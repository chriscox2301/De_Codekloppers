...
namespace DataAccessLayer
{
    public static class MatrixIncDbInitializer
    {
        public static void Initialize(MatrixIncDbContext context)
        {
            ...
            {
                new Product { Name = "Nebuchadnezzar",ProductCode = "AAAAAAAA", Description = "Het schip waarop Neo voor het eerst de echte wereld leert kennen", Price = 10000.00m },
                new Product { Name = "Jack-in Chair", ProductCode = "1AAAAAAA", Description = "Stoel met een rugsteun en metalen armen waarin mensen zitten om ingeplugd te worden in de Matrix via een kabel in de nekpoort", Price = 500.50m },
                new Product { Name = "EMP (Electro-Magnetic Pulse) Device",ProductCode = "11AAAAAA" ,Description = "Wapentuig op de schepen van Zion", Price = 129.99m }
            };
